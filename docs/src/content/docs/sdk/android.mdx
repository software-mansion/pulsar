...
<CollapsibleTable
  ...
  codeColumns={[0, 1]}
  rows={[
    ["systemCalendarDatePreset()", "HapticFeedbackConstants.CALENDAR_DATE"],
    ["systemClockTickPreset()", "HapticFeedbackConstants.CLOCK_TICK"],
    ["systemConfirmPreset()", "HapticFeedbackConstants.CONFIRM"],
    ["systemContextClickPreset()", "HapticFeedbackConstants.CONTEXT_CLICK"],
    ["systemDragCrossingPreset()", "HapticFeedbackConstants.DRAG_CROSSING"],
    ["systemDragStartPreset()", "HapticFeedbackConstants.DRAG_START"],
    ["systemEdgeReleasePreset()", "HapticFeedbackConstants.EDGE_RELEASE"],
    ["systemEdgeSqueezePreset()", "HapticFeedbackConstants.EDGE_SQUEEZE"],
    ["systemEffectClickPreset()", "VibrationEffect.EFFECT_CLICK"],
    ["systemEffectDoubleClickPreset()", "VibrationEffect.EFFECT_DOUBLE_CLICK"],
    ["systemEffectHeavyClickPreset()", "VibrationEffect.EFFECT_HEAVY_CLICK"],
    ["systemEffectTickPreset()", "VibrationEffect.EFFECT_TICK"],
    ["systemGestureEndPreset()", "HapticFeedbackConstants.GESTURE_END"],
    ["systemGestureStartPreset()", "HapticFeedbackConstants.GESTURE_START"],
    ["systemKeyboardPressPreset()", "HapticFeedbackConstants.KEYBOARD_PRESS"],
    ["systemKeyboardReleasePreset()", "HapticFeedbackConstants.KEYBOARD_RELEASE"],
    ["systemKeyboardTapPreset()", "HapticFeedbackConstants.KEYBOARD_TAP"],
    ["systemLongPressPreset()", "HapticFeedbackConstants.LONG_PRESS"],
    ["systemPrimitiveClickPreset()", "VibrationEffect.Composition.PRIMITIVE_CLICK"],
    ["systemPrimitiveLowTickPreset()", "VibrationEffect.Composition.PRIMITIVE_LOW_TICK"],
    ["systemPrimitiveQuickFallPreset()", "VibrationEffect.Composition.PRIMITIVE_QUICK_FALL"],
    ["systemPrimitiveQuickRisePreset()", "VibrationEffect.Composition.PRIMITIVE_QUICK_RISE"],
    ["systemPrimitiveSlowRisePreset()", "VibrationEffect.Composition.PRIMITIVE_SLOW_RISE"],
    ["systemPrimitiveSpinPreset()", "VibrationEffect.Composition.PRIMITIVE_SPIN"],
    ["systemPrimitiveThudPreset()", "VibrationEffect.Composition.PRIMITIVE_THUD"],
    ["systemPrimitiveTickPreset()", "VibrationEffect.Composition.PRIMITIVE_TICK"],
    ["systemReleasePreset()", "HapticFeedbackConstants.REJECT"],
    ["systemScrollItemFocusPreset()", "HapticFeedbackConstants.SCROLL_ITEM_FOCUS"],
    ["systemScrollLimitPreset()", "HapticFeedbackConstants.SCROLL_LIMIT"],
    ["systemScrollTickPreset()", "HapticFeedbackConstants.SCROLL_TICK"],
    ["systemSegmentFrequentTickPreset()", "HapticFeedbackConstants.SEGMENT_FREQUENT_TICK"],
    ["systemSegmentTickPreset()", "HapticFeedbackConstants.SEGMENT_TICK"],
    ["systemTextHandleMovePreset()", "HapticFeedbackConstants.TEXT_HANDLE_MOVE"],
    ["systemToggleOffPreset()", "HapticFeedbackConstants.TOGGLE_OFF"],
    ["systemToggleOnPreset()", "HapticFeedbackConstants.TOGGLE_ON"],
    ["systemVirtualKeyPreset()", "HapticFeedbackConstants.VIRTUAL_KEY"],
    ["systemVirtualKeyReleasePreset()", "HapticFeedbackConstants.VIRTUAL_KEY_RELEASE"],
  ]}
/>
