...
| **Impact follower** | Instant attack, slow release - the waveform tracked sample by sample |
| **Transient taps** | Note attacks found by phase prediction, laid down as discrete taps |
...
| **Melodic transcode** | Melodic contour into the frequency layer - shape, not intervals |
