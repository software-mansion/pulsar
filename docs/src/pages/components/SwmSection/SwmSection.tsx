  ...
  return <div className={`${styles.section} ${className || ''}`}>
    ...
    <BasicLayout>
      ...
      <div className={styles.iconBar}>
        <a href='#'><img src={social_x.src} /></a>
        <a href='#'><img src={social_fb.src} /></a>
        <a href='#'><img src={social_git.src} /></a>
        <a href='#'><img src={social_ig.src} /></a>
        <a href='#'><img src={social_yt.src} /></a>
        <a href='#'><img src={social_in.src} /></a>
        <a href='#'><img src={social_drb.src} /></a>
      </div>
    </BasicLayout>
  </div>
}
