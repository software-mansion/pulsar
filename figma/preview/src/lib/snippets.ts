...
// SDK code-snippet generators for the preset-details modal. Pure functions (no
// React) so they can be unit-tested and kept out of the component. Each snippet
// is quoted from the matching `docs/src/content/docs/sdk/*.mdx` page.

// Order chosen to match the docs SDK overview page.
export const LANGS = ['Swift', 'Android', 'KMP', 'React Native', 'Flutter', 'Web'] as const;
