// Ported from pulsar/docs/src/content/docs/components/Preset/audio-player.ts
...
// Convenience: parse + play a preset by its data.
const cache = new Map<string, AudioPatternUtility>();
export async function playPreset(id: string, data: PresetData) {
