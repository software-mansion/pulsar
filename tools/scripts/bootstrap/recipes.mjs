...
// toolchain versions live centrally in tools/scripts/bootstrap/toolchain.json and are
...
export const recipes = {
  ...
  flutter: {
    ...
    // blocks; assets/ holds the audio clip + Lottie animation for the demos.
    content: ['lib/main.dart', 'ios/Podfile', 'assets/sample-3s.mp3', 'assets/verified.json'],
    // pubspec is generated by `flutter create`; inject the path dependencies.
    pubspecDependency: { name: 'pulsar_haptics', path: '../pulsar' },
    // pulsar_haptics_lottie brings the Lottie widget; it declares a *hosted*
    // pulsar_haptics dep, so override that onto the local path package too.
    pubspecDependencies: [{ name: 'pulsar_haptics_lottie', path: '../PulsarLottie' }],
    pubspecOverrides: [{ name: 'pulsar_haptics', path: '../pulsar' }],
    // ...and declare the bundled assets in the regenerated pubspec.
    pubspecAssets: ['assets/sample-3s.mp3', 'assets/verified.json'],
  ...
  android: {
    ...
    // central tools/scripts/bootstrap/toolchain.json — the one place to bump versions.
    ...
    notes:
      ...
      'AGP/Gradle/Kotlin/Compose-BOM versions are synced from tools/scripts/bootstrap/toolchain.json (the one ' +
  ...
  kmp: {
    ...
    // Android SDK levels) from tools/scripts/bootstrap/toolchain.json.
    toolchainKey: 'kmp',
    ...
    notes:
      ...
      'from tools/scripts/bootstrap/toolchain.json. iOS uses the vendored Kotlin/Native impl (no USE_LOCAL toggle); ' +
...
function iosProjectYml({ local, iosVersion, iosSwiftPackageUrl }) {
  ...
  return `# Generated by tools/scripts/bootstrap-app.mjs — declarative source for PulsarApp.xcodeproj.
