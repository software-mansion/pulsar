...
class RipplePreset(haptics: Pulsar) :
    ...
    Player(haptics, PatternData(
        rawContinuousPattern = listOf(
            listOf(listOf(0.0f, 0.0f), listOf(5.0f, 1.0f), listOf(70.0f, 0.0f), listOf(145.0f, 0.5f), listOf(200.0f, 0.0f), listOf(265.0f, 0.2f), listOf(310.0f, 0.0f), listOf(365.0f, 0.07f), listOf(420.0f, 0.0f)),
            listOf(listOf(0.0f, 0.7f), listOf(140.0f, 0.5f), listOf(260.0f, 0.33f), listOf(420.0f, 0.18f)),
        ),
        rawDiscretePattern = listOf(
            listOf(0.0f, 1.0f, 0.65f),
