...
/// ```dart
/// // Update the haptic as the user drags (auto-starts playback)
...
class PulsarRealtimeComposer {
  ...
  /// Set the continuous haptic parameters.
  ///
  /// Auto-starts playback on the first call and updates the parameters on
  /// subsequent calls. Playback stops automatically shortly after the last
  /// [set] (a built-in keepalive) or when [stop] is called explicitly.
